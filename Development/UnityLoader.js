...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Immersive_Modelling-2016-03-08.data';
    var REMOTE_PACKAGE_BASE = 'Immersive_Modelling-2016-03-08.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 14344007;
      var PACKAGE_UUID = '4d9922f4-44bc-40c2-92f2-0d801e0ece6e';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 11367940, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(11367940, 11367961, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(11367961, 11368429, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(11368429, 12819689, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(12819689, 14316381, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(14316381, 14344007, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Immersive_Modelling-2016-03-08.data');

    };
    Module['addRunDependency']('datafile_Immersive_Modelling-2016-03-08.data');
